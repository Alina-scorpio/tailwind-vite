...
const Navbar = ({ handleOrderPopup }) => {
  return (
    <>
      <div className="shadow-md bg-red dark:bg-gray-900 dark:text-white duration-200 relative z-40">
          ...
          <div className="flex justify-between items-center">
            <div>
              <a href="#" className="text-2xl sm:text-3xl flex gap-2">
                ...
                <span className="font-bold text-secondary">Hand</span>
                <span className="font-bold text-primary">Made</span>
              </a>
            </div>
              ...
              <ul className="hidden md:flex items-center gap-4">
                {Menu.map((menu) => (
                  <li key={menu.id}>
                    <a
                      href={menu.link}
                      className="inline-block py-4 px-4 hover:underline"
                    >
                      {menu.name}
                    </a>
                  </li>
